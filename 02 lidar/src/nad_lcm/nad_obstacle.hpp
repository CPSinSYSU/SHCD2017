...
#ifndef __nad_lcm_nad_obstacle_hpp__
#define __nad_lcm_nad_obstacle_hpp__
...
int nad_obstacle::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int nad_obstacle::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int nad_obstacle::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t nad_obstacle::getHash()
{
    static int64_t hash = _computeHash(NULL);
    return hash;
}

const char* nad_obstacle::getTypeName()
{
    return "nad_obstacle";
}

int nad_obstacle::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int nad_obstacle::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int nad_obstacle::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t nad_obstacle::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0x4f548b68511de4b8LL;
